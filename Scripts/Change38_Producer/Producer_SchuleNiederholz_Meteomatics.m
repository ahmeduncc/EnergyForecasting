%% Meteomatics forecasting example: Change38 producer Schule Niederholz
...
period      = 'P186DT';
resolution  = 'PT15M'; 
parameters = 'solar_power_installed_capacity_0.1:MW'; 
...
producerData = load('..\..\Data\Change38_Producer\Producer_Schule_Niederholz_20170609.txt');
...
title('Energieproduktion: Schule Niederholz');
xlabel('Tage');
ylabel('kWh');
axis tight;
hold off;
...
title('Energieproduktion: Schule Niederholz Februar und März 2017');
xlabel('Tage');
ylabel('kWh');
legend('COPCO Sensordaten', 'Meteomatics Prognosen')
axis tight;
...
title('Energieproduktion: Schule Niederholz, Mai, Juni 2017');
xlabel('Tage');
ylabel('kWh');
legend('COPCO Sensordaten', 'Meteomatics Prognosen')
axis tight;
