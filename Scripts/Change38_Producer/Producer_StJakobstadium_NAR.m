%% NAR forecasting example: Change38 producer St. Jakobstadium

%% Initialization
clear; close all; clc;

%% train and test NAR model

% Solve an Autoregression Time-Series Problem with a NAR Neural Network
% Script generated by Neural Time Series app
% Created 29-Mar-2017 00:54:52
%

data_range = (23 + 85*96):(23 + 85*96 + 10*96 - 1);
producerData = load('..\..\Data\Change38_Producer\Producer_StJakobstadium.txt');
% target = producerData(:,3)/10^3;          % kWH
target = producerData(data_range,3)/10^3;   % kWH
x = 1:0.1:2;
% target = sin(x)';
...
figure, plot(1:(length(target) + plot_index), [target' cell2mat(y2)], 'b');
